...
基于 Node.js 的 QQ 农场自动化工具，提供多账号挂机、农场与好友自动化、作物与超变图鉴、活动中心、商城、数据分析和 Web 控制面板。当前项目版本为 `20260907`，游戏协议版本为 `1.13.3.17_20260826`。
...
- 支持抓包 Code 登录、微信小程序扫码登录和 QQ 小程序扫码登录
...
4. 在设置页添加游戏账号，可使用有效 Code、微信扫码或 QQ 扫码登录。
